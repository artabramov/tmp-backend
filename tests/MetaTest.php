...
class MetaTest extends TestCase
{
    ...
    protected function truncate() {
        $stmt = $this->pdo->query( "TRUNCATE TABLE meta;" );
    }

    protected function insert() {
        $stmt = $this->pdo->query( "INSERT INTO meta VALUES (1, '0001-01-01 00:00:00', '0001-01-01 00:00:00', 'parent', 1, 'key', 'value');" );
    }
    ...
    public function addSet() {
        return [
            ...
            // correct cases
            [ ['create_date' => '0001-01-01 00:00:00', 'update_date' => '0001-01-01 00:00:00', 'parent_type' => 'parent', 'parent_id' => '1', 'meta_key' => 'key', 'meta_value' => 'value'], [true, ''] ],
