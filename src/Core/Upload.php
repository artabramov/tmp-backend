...
class Upload extends \App\Core\Echidna
{
    ...
    public function set( array $data ) : bool {
        ...
        } elseif( $this->is_exists( 'post_uploads', [['upload_file', '=', $data['upload_file']]] )) {
    ...
    public function put( array $data ) : bool {
        ...
        } elseif( !$this->update( 'post_uploads', [['id', '=', $this->id]], $data )) {
    ...
    public function del() : bool {
        ...
        } elseif( !$this->delete( 'post_uploads', [['id', '=', $this->id]] )) {
